...
Construct a tidygraph network object from various input types. All
builders return a module-annotated graph ready for
...
- [`build_graph_from_pie()`](https://jiawang1209.github.io/ggNetView/reference/build_graph_from_pie.md)
  : Build a pie graph object from a data frame
- [`build_graph_from_enrichGO()`](https://jiawang1209.github.io/ggNetView/reference/build_graph_from_enrichGO.md)
...
Plot networks, heatmaps, and multi-network comparisons.
...
- [`ggNetView_multi_link()`](https://jiawang1209.github.io/ggNetView/reference/ggNetView_multi_link.md)
  : Visualize multiple networks and show the connections between them to
  highlight key members within the networks
...
- [`ggnetview_zipi()`](https://jiawang1209.github.io/ggNetView/reference/ggnetview_zipi.md)
  : Compute Zi-Pi (within-module connectivity and participation
  coefficient)
...
Compute topology metrics, extract subgraphs, and perform statistical
tests.
...
- [`get_sample_subgraph()`](https://jiawang1209.github.io/ggNetView/reference/get_sample_subgraph.md)
...
- [`get_node_influence()`](https://jiawang1209.github.io/ggNetView/reference/get_node_influence.md)
  : Propagate a virtual perturbation from source node(s) across the
  network
...
- [`mantel_pairwise()`](https://jiawang1209.github.io/ggNetView/reference/mantel_utils.md)
  [`mantel_between_blocks()`](https://jiawang1209.github.io/ggNetView/reference/mantel_utils.md)
  [`mantel_block_vs_col()`](https://jiawang1209.github.io/ggNetView/reference/mantel_utils.md)
  : Mantel test utilities for species-environment distance matrix
  correlation

## Correlation & inference engines

Low-level correlation and network-inference functions powered by Rcpp.
These are called internally by the builders but can also be used
directly.

- [`sparcc_matrix_rcpp()`](https://jiawang1209.github.io/ggNetView/reference/sparcc_matrix_rcpp.md)
  : SparCC correlation matrix (Rcpp implementation)
- [`sparcc_pvalue_rcpp()`](https://jiawang1209.github.io/ggNetView/reference/sparcc_pvalue_rcpp.md)
  : SparCC p-value matrix (Rcpp implementation)
- [`spieceasi_matrix_rcpp()`](https://jiawang1209.github.io/ggNetView/reference/spieceasi_matrix_rcpp.md)
  : SPIEC-EASI matrix (Rcpp implementation)

## Graph utilities

Extract, transform, reorder, and export graph components.
...
- [`order_graph()`](https://jiawang1209.github.io/ggNetView/reference/order_graph.md)
  : Reorder the Modularity from graph object
- [`update_graph_modules()`](https://jiawang1209.github.io/ggNetView/reference/update_graph_modules.md)
  : Update module names in an existing graph object
- [`update_graph_modules2()`](https://jiawang1209.github.io/ggNetView/reference/update_graph_modules2.md)
  : Update module assignments from an existing column in graph object
- [`export_ggnetview()`](https://jiawang1209.github.io/ggNetView/reference/export_ggnetview.md)
...
- [`angle_utils`](https://jiawang1209.github.io/ggNetView/reference/angle_utils.md)
  : Angle helpers for ggNetView layout parameters
- [`deg()`](https://jiawang1209.github.io/ggNetView/reference/deg.md) :
  Convert degrees to radians

## Themes & scales

ggplot2 theme and colour/fill scale helpers for consistent network
aesthetics.

- [`theme_ggnetview()`](https://jiawang1209.github.io/ggNetView/reference/theme_ggnetview.md)
  : ggNetView Theme
...
- [`get_palette()`](https://jiawang1209.github.io/ggNetView/reference/get_palette.md)
  : Generate a named color palette for discrete classes

## Datasets

Bundled example data used throughout the documentation, vignettes and
`\examples`.

- [`otu_tab`](https://jiawang1209.github.io/ggNetView/reference/otu_tab.md)
  : Example OTU abundance table
- [`otu_rare`](https://jiawang1209.github.io/ggNetView/reference/otu_rare.md)
  : Rarefied OTU abundance table
- [`otu_rare_relative`](https://jiawang1209.github.io/ggNetView/reference/otu_rare_relative.md)
  : Relative-abundance OTU table
- [`otu_sample`](https://jiawang1209.github.io/ggNetView/reference/otu_sample.md)
  : Sample metadata for the OTU example
- [`tax_tab`](https://jiawang1209.github.io/ggNetView/reference/tax_tab.md)
  : Taxonomy annotation table
- [`otu_NatureWater`](https://jiawang1209.github.io/ggNetView/reference/otu_NatureWater.md)
  : Larger OTU table from a published water-quality study
- [`tax_NatureWater`](https://jiawang1209.github.io/ggNetView/reference/tax_NatureWater.md)
  : Taxonomy table for \[otu_NatureWater\]
- [`BASV_tab`](https://jiawang1209.github.io/ggNetView/reference/BASV_tab.md)
  : Bacterial ASV demonstration table
- [`FASV_tab`](https://jiawang1209.github.io/ggNetView/reference/FASV_tab.md)
  : Fungal ASV demonstration table
- [`Spedf`](https://jiawang1209.github.io/ggNetView/reference/Spedf.md)
  : Species composition table for link-heatmap examples
- [`Envdf`](https://jiawang1209.github.io/ggNetView/reference/Envdf.md)
  : Environmental variables (single block)
- [`Envdf_4st`](https://jiawang1209.github.io/ggNetView/reference/Envdf_4st.md)
  : Environmental variables across four sampling stages
- [`Envdf_4st_2`](https://jiawang1209.github.io/ggNetView/reference/Envdf_4st_2.md)
  : Alternative four-stage environmental dataset
- [`adjacency_matrix_example`](https://jiawang1209.github.io/ggNetView/reference/adjacency_matrix_example.md)
  : Pre-computed adjacency matrix
- [`double_mat_node_df`](https://jiawang1209.github.io/ggNetView/reference/double_mat_node_df.md)
  : Two-block node table for double-matrix examples
- [`double_mat_node_df_with_modularity`](https://jiawang1209.github.io/ggNetView/reference/double_mat_node_df_with_modularity.md)
  : Two-block node table with pre-computed modularity
- [`ppi_example`](https://jiawang1209.github.io/ggNetView/reference/ppi_example.md)
  : Protein-protein interaction example
- [`ppi_module`](https://jiawang1209.github.io/ggNetView/reference/ppi_module.md)
  : Protein-protein interaction example with module assignment

## Re-exports

- [`` `%>%` ``](https://jiawang1209.github.io/ggNetView/reference/pipe.md)
  : Pipe operator
